...
impl Rope {
    ...
    pub fn point_utf16_to_offset(&self, point: PointUtf16) -> usize {
        self.point_utf16_to_offset_impl(point)
    }

    pub fn unclipped_point_utf16_to_offset(&self, point: Unclipped<PointUtf16>) -> usize {
        self.point_utf16_to_offset_impl(point.0)
    }

    fn point_utf16_to_offset_impl(&self, point: PointUtf16) -> usize {
        ...
        cursor.start().1
            + cursor
                .item()
                .map_or(0, |chunk| chunk.as_slice().point_utf16_to_offset(overshoot))
    }
