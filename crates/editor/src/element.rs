use crate::{
    ActiveDiagnostic, BlockId, COLUMNAR_SELECTION_MODIFIERS, ChunkRendererContext,
    ...
    MIN_LINE_NUMBER_DIGITS, MINIMAP_FONT_SIZE, MULTI_BUFFER_EXCERPT_HEADER_HEIGHT, OpenExcerpts,
...
use project::project_settings::{GitGutterSetting, GitHunkStyleSetting, ProjectSettings};
...
impl SelectionLayout {
    fn new<T: ToPoint + ToDisplayPoint + Clone>(
        ...
        let range = display_selection.range();
        ...
        editor_with_selections.update(cx, |editor, cx| {
            ...
            if let Some(collaboration_hub) = &editor.collaboration_hub {
                ...
                let layouts = snapshot
                    ...
                    .map(move |(_, _, cursor_shape, selection)| {
                        SelectionLayout::new(
                            selection,
                            cursor_shape,
                            &snapshot.display_snapshot,
